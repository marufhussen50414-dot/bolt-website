  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        "character-fly": "characterFly 12s ease-in-out infinite",
      },
      keyframes: {
        ...
        characterFly: {
          "0%":   { transform: "translate(-170px, 6px) scale(0.6) rotate(-6deg)", opacity: "0" },
          "10%":  { opacity: "1" },
          "24%":  { transform: "translate(0, 0) scale(1) rotate(0deg)", opacity: "1" },
          "36%":  { transform: "translate(0, -10px) scale(1) rotate(2deg)", opacity: "1" },
          "48%":  { transform: "translate(0, 0) scale(1) rotate(0deg)", opacity: "1" },
          "60%":  { transform: "translate(0, -10px) scale(1) rotate(-2deg)", opacity: "1" },
          "72%":  { transform: "translate(0, 0) scale(1) rotate(0deg)", opacity: "1" },
          "84%":  { opacity: "1" },
          "92%":  { transform: "translate(170px, 6px) scale(0.6) rotate(6deg)", opacity: "0" },
          "100%": { transform: "translate(170px, 6px) scale(0.6) rotate(6deg)", opacity: "0" },
        },
      },
    },
  },
