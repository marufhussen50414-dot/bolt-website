  ...
  return (
    <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-10">
      <div className="text-center mb-12">
        ...
        <p className="text-ink-400 mt-2 max-w-xl mx-auto">Buy and sell game IDs safely with escrow protection and only 2% commission</p>
      </div>
      <div className="grid md:grid-cols-2 gap-5 mb-12">
        ...
        { title: "For Sellers", steps: [
          ...
          { icon: TrendingUp, title: "Get Paid (98%)", desc: "Once the buyer confirms, you receive 98% of the price — only 2% commission." },
      ...
      <div className="card p-8 bg-gradient-to-r from-primary-500/10 to-accent-500/10 border-primary-500/20">
        ...
        <div className="grid sm:grid-cols-3 gap-5 mt-6">
          {[{ icon: ShieldCheck, title: "Escrow Protected", desc: "Money held safely until both parties confirm." }, { icon: CheckCircle2, title: "Verified Sellers", desc: "Trust scores and reviews from real transactions." }, { icon: TrendingUp, title: "Lowest Fees", desc: "Only 2% commission. No hidden charges." }].map((f) => (
